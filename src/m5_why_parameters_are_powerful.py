...
def main():
    ...
    #even_better_draw_circles(rg.Point(0,0),10,20,'blue',10)
    #even_better_draw_circles(rg.Point(-200,200),50,15,'green',5)
    even_better_draw_circles(rg.Point(0,0),20,15,'blue',5)
    even_better_draw_circles(rg.Point(0,0),15,20,'yellow',5)
    even_better_draw_circles(rg.Point(0,0),12,22,'purple',5)
