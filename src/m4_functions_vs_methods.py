...
def try_methods():
    ...
    ###########################################################################
    turtlethree=rg.SimpleTurtle()
    turtlethree.pen=rg.Pen('brown',5)
    turtlethree.forward(150)
    turtlethree.left(90)
    turtlethree.forward(50)
    turtlethree.backward(100)
...
def try_methods_and_functions():
    ...
    turtlefour=rg.SimpleTurtle()
    turtlefour.pen=rg.Pen('blue',5)
    turtlefour.backward(150)
    turtlefour.speed=1
    draw_many_squares(turtlefour,2,100,30)
    turtlefour.speed=5
    turtlefour.pen=rg.Pen('red',5)
    draw_many_squares(turtlefour,10,50,15)
    turtlefour.speed=100
    turtlefour.pen=rg.Pen('red',35)
    draw_many_squares(turtlefour,8,300,60)
    turtlefour.pen=rg.Pen('black',3)
    turtlefour.backward(200)
    turtlefour.draw_circle(30)
    turtlefour.draw_square(50)
